...
- Central learning trains a single policy over the joint-action space A = A_1 x ... x A_n, reducing MARL to single-agent RL but suffering from exponential action space growth.
